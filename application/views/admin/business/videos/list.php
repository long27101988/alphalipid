<section class="maincontent noright">
    <div class="maincontentinner">
        <ul class="maintabmenu">
            <li><a href="<?php echo base_url(); ?>admin/business">Business</a></li>
        ...
        <div class="content">
            ...
            <div class="tableoptions">
                <button class="addbutton radius3" title="table2" onclick="location.href='<?php echo base_url(); ?>admin/business/video_add';">Add</button> &nbsp;
                    ...
                    <tbody>    
                        ...
                        foreach ($all_business as $item){ ?>
                            <tr>
                                ...
                                <td class="center"><a href="<?php echo base_url(); ?>admin/business/video_edit/<?php echo $item['id']; ?>" class="edit">Edit</a> - <a href="<?php echo base_url(); ?>admin/business/video_del/<?php echo $item['id']; ?>" class="delete" onclick="return confirm_del();">Delete</a></td>
                            </tr>
                        <?php  }
                        }else{
                            echo "<tr>";
                ...
                function changState(_this){
                    ...
                    jQuery.ajax({
                        url: "<?php echo base_url(); ?>admin/business/update_video_state", // Url to which the request is send
