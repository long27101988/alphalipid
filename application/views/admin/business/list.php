<section class="maincontent noright">
    <div class="maincontentinner">
        <ul class="maintabmenu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/business/video_index">Videos</a></li>
        </ul>
        <!--maintabmenu-->
        <div class="content">
            ...
            ?>
                <div class="tableoptions">
                    <button class="addbutton radius3" title="table2" onclick="location.href='<?php echo base_url(); ?>admin/business/add';">Add</button> &nbsp;
                            ...
                            <?php if(!empty($all_business )){
                             foreach ($all_business as $item){ ?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo $item['province']; ?></td>
                                    <td align="center"><?php echo $item['contact_name']; ?></td>
                                    ...
                                    <td class="center"><a href="<?php echo base_url(); ?>admin/business/edit/<?php echo $item['id']; ?>" class="edit">Edit</a> - <a href="<?php echo base_url(); ?>admin/business/del/<?php echo $item['id']; ?>" class="delete" onclick="return confirm_del();">Delete</a></td>
                                </tr>
                            <?php  }
                            }else{
                                echo "<tr>";
                                    echo "<td colspan='8' align='center'>EMPTY DATA !!!</td>";
                                echo "</tr>";
                            }?>
                        </tbody>
                    </table>
                    ...
                    function changState(_this){
                        ...
                        jQuery.ajax({
                            url: "<?php echo base_url(); ?>admin/business/update_state", // Url to which the request is send
