<section class="maincontent noright">
    <div class="maincontentinner">
        ...
        <div class="content">
            ...
            <form id="formAddVideoIntro" class="stdform" method="post" action="<?php echo base_url(); ?>admin/intro/video_add">
                <p>
                    <label>Title</label>
                ...
                <p class="stdformbutton">
                    <button class="submit radius2" name="btnAddVideoIntro">Add</button>
                </p>
            </form>
        </div>
        <!--content-->
