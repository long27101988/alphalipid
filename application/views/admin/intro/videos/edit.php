<section class="maincontent noright">
    <div class="maincontentinner">
        ...
        <div class="content">
            ...
            <form id="formEditVideoIntro" class="stdform" method="post" action="<?php echo base_url(); ?>admin/intro/video_edit/<?php echo $info['id']; ?>">
                <p>
                    <label>Title</label>
                ...
                <p class="stdformbutton">
                    <button class="submit radius2" name="btnEditVideoIntro">Chỉnh sửa</button>
                </p>
            </form>
        </div>
        <!--content-->
