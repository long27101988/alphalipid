    ...
    <div class="maincontentinner">
        ...
        <div class="content">
            ...
            <div class="tableoptions">
                <button class="addbutton radius3" title="table2" onclick="location.href='<?php echo base_url(); ?>admin/faqs/add';">Add</button> &nbsp;
            ...
            <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                <thead>
                    <tr>
                        ...
                        <th class="head0">Câu hỏi</th>
                        <th class="head0">Trả lời</th>
                ...
                <tbody>
                    ...
                    foreach ($all_faqs as $item){ ?>
                        <tr>
                            ...
                            <td><?php echo $this->function->the_excerpt(strip_tags($item['question']),200).'
                            ...'; ?></td>
                            <td><?php echo $this->function->the_excerpt(strip_tags($item['answer']),200).'
                            ...'; ?></td>
                            ...
                            <td class="center"><a href="<?php echo base_url(); ?>admin/faqs/edit/<?php echo $item['id']; ?>" class="edit">Edit</a> - <a href="<?php echo base_url(); ?>admin/faqs/del/<?php echo $item['id']; ?>" class="delete" onclick="return confirm_del();">Delete</a></td>
                        </tr>
                    <?php  }
                    }else{
                        echo "<tr>";
            ...
            function changState(_this){
                ...
                jQuery.ajax({
                    url: "<?php echo base_url(); ?>admin/faqs/update_state", // Url to which the request is send
            ...
            function delRowsSelected(){
                ...
                jQuery.ajax({
                    url: "<?php echo base_url(); ?>admin/faqs/del_rows_selected", // Url to which the request is send
                    type: "POST", // Type of request to be send, called as method
