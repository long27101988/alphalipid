    ...
    <div class="maincontentinner">
        ...
        <div class="content">
            ...
            <div class="tableoptions">
                <button class="addbutton radius3" title="table2" onclick="location.href='<?php echo base_url(); ?>admin/slider/add';">Add</button> &nbsp;
                    ...
                    <tbody>
                        ...
                        foreach ($all_sliders as $item){ ?>
                        	<tr>
                                ...
                                <td class="center"><a href="<?php echo base_url(); ?>admin/slider/edit/<?php echo $item['id']; ?>" class="edit">Edit</a> - <a href="<?php echo base_url(); ?>admin/slider/del/<?php echo $item['id']; ?>" class="delete" onclick="return confirm_del();">Delete</a></td>
                            </tr>
                        <?php  }
                        }else{
                            echo "<tr>";
                ...
                <script type="text/javascript">
                    ...
                    jQuery.ajax({
                        url: "<?php echo base_url(); ?>admin/slider/update_state", // Url to which the request is send
