<section class="maincontent noright">
    <div class="maincontentinner">
        <ul class="maintabmenu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/news/video_index">Videos</a></li>
        </ul>
        <!--maintabmenu-->
        <div class="content">
            <?php 
            ...
            <div class="tableoptions">
                ...
                <?php foreach($group_news as $value){ ?>
                    <option value="<?= $value['id']?>" <?php if($value['id'] == $id){echo "selected='selected'";} ?>><?php echo $value['title'];?></option>
                <?php }?>
                </select> 
                    ...
                    <tbody>    
                        ...
                        foreach ($all_news as $item){ ?>
                        	<tr>
                                ...
                                <td align="center"><?php echo $item['desc']; ?></td>
                                <td align="center"><img src="<?php echo base_url(); ?>/uploads/<?php echo $item['url']; ?>" alt="" width="50px"></td>
                                ...
                                <td class="center"><a href="<?php echo base_url(); ?>admin/news/edit/<?php echo $item['id']; ?>" class="edit">Edit</a> - <a href="<?php echo base_url(); ?>admin/news/del/<?php echo $item['id']; ?>" class="delete" onclick="return confirm_del();">Delete</a></td>
                            </tr>
                        <?php  }
                        }else{
                            echo "<tr>";
                                echo "<td colspan='9' align='center'>EMPTY DATA !!!</td>";
                            echo "</tr>";
                        }?> 
                    </tbody>
                </table>
                ...
                function changState(_this){
                    ...
                    jQuery.ajax({
                        url: "<?php echo base_url(); ?>admin/news/update_new_state", // Url to which the request is send
                ...
                function changeGroupNews(_this){
                    ...
                    jQuery.ajax({
                        url: "<?php echo base_url(); ?>admin/news/load_news_by_category", // Url to which the request is send
                        type: "POST", // Type of request to be send, called as method
                        ...
                        success: function(data) // A function to be called if request succeeds
                        {
                            ...
                            window.location.href = "/admin/news/index/" + data;
                        }
                    });
                }
                </script>
